...
- Création d'un script de suppression de la base de donnée, re création et insertion en base de donnée à partir de bdd-livret.sql ( sera très utile pour les futur test unitaires) " npm run db-reset "
